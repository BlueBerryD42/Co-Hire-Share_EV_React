          ...
          <div className="space-y-4">
            <TextField
              ...
              onChange={(event) =>
                setRules((prev) => ({
                  ...prev,
                  bookingWindow: event.target.value,
                }))
              }
              fullWidth
              sx={{ mb: 3 }}
            ...
            <Alert severity="info" sx={{ mt: 2 }}>
              Các quy tắc này sẽ được lưu trong mô tả nhóm và hiển thị cho mọi
        ...
        {activeStep === 3 && (
          <div className="space-y-4">
            <Alert severity="info" sx={{ mb: 3 }}>
              Bạn có thể thêm xe vào nhóm ngay bây giờ hoặc thêm sau khi nhóm
              được phê duyệt. Không có giới hạn số lượng xe trong một nhóm.
            </Alert>
            <Button
              variant="outlined"
              startIcon={<Car />}
            ...
            <Alert severity="success" sx={{ mt: 2 }}>
              Sau khi nhóm được phê duyệt, bạn có thể thêm xe từ trang "Xe của
              tôi" hoặc trang chi tiết nhóm.
            </Alert>
          </div>
        )}
      </div>
