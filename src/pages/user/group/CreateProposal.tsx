...
const CreateProposal = () => {
  ...
  const [form, setForm] = useState({
    ...
    votingEndDate: formatDateTimeLocal(
  ...
  const [documentSignatures, setDocumentSignatures] =
    useState<DocumentSignatureStatusResponse | null>(null);
  ...
  const fetchDocuments = async () => {
    ...
    try {
      ...
      const docs = await documentApi.getGroupDocuments(groupId as UUID, {
        page: 1,
        pageSize: 100,
      });
      ...
      <section className="grid gap-6 md:grid-cols-2">
        <div className="space-y-4 rounded-3xl border border-neutral-200 bg-white p-6">
          ...
          <Select
            ...
            value={form.type}
            onChange={(event) =>
              handleChange("type", event.target.value as ProposalType)
            }
            fullWidth
            sx={{ mb: 3 }}
          >
          ...
          <div className="mb-6">
            ...
            <Slider
              ...
              step={5}
              onChange={(_, value) =>
                handleChange("requiredMajority", value as number)
              }
            />
          </div>
          ...
          <Card sx={{ mb: 3, bgcolor: "#f5ebe0" }}>
            <CardContent>
              ...
              {attachedDocuments.length === 0 ? (
                ...
                >
                  <DescriptionIcon
                    sx={{ fontSize: 48, color: "#d0d0d0", mb: 1 }}
                  />
                            ...
                            primary={
                              <Box sx={{ mb: 1 }}>
                                ...
                                >
                                  ...
                                  />
                                  <Chip
                                    label={getSignatureStatusName(
                                      doc.signatureStatus
                                    )}
                                    size="small"
                                    sx={{
                                      bgcolor: getSignatureStatusColor(
                                        doc.signatureStatus
                                      ),
                                      color: "white",
                                      fontSize: "0.7rem",
                            ...
                            secondary={
                              <Box sx={{ mt: 1 }}>
                                <Typography
                                  ...
                                  sx={{ mb: 0.5 }}
                                >
                                  📄 {formatFileSize(doc.fileSize)} • Due Date:{" "}
        ...
        <div className="space-y-4 rounded-3xl border border-neutral-200 bg-neutral-50 p-6">
          ...
          <div className="rounded-2xl border border-neutral-200 bg-white p-4 text-sm text-neutral-600">
            Bỏ phiếu từ {new Date(form.votingStartDate).toLocaleString("vi-VN")}{" "}
            đến {new Date(form.votingEndDate).toLocaleString("vi-VN")}
          </div>
        </div>
      </section>
            ...
            <List>
              {availableDocuments.map((doc) => (
                <ListItemButton
                  ...
                  sx={{
                    bgcolor: attachedDocuments.includes(doc.id)
                      ? "#f0f0f0"
                      : "white",
                    borderRadius: 1,
                    mb: 1,
                    ...
                    secondary={
                      <Box sx={{ mt: 0.5 }}>
                        ...
                        <Typography
                          ...
                          display="block"
                        >
                          {formatFileSize(doc.fileSize)} • Tải lên:{" "}
      ...
      >
            ...
            >
              ...
              >
                {previewError ? (
                  ...
                  >
                    <PreviewIcon
                      sx={{ fontSize: 80, color: "#d0d0d0", mb: 2 }}
                    />
                    <Typography variant="body2" color="text.secondary">
              ...
              <Box sx={{ overflow: "auto", bgcolor: "#fafafa", p: 3 }}>
                <Typography
                  variant="h6"
                  sx={{ mb: 2, fontWeight: 600, color: "#7a9b76" }}
                >
                  Trạng thái ký
                </Typography>
                ...
                {!documentSignatures ? (
                  ...
                  <Box>
                    ...
                    >
                      ...
                      >
                        {documentSignatures.signedCount} /{" "}
                        {documentSignatures.totalSigners} người đã ký
                      </Typography>
                    </Box>
        ...
        <DialogActions sx={{ borderTop: "1px solid #e0e0e0", p: 2 }}>
          <Button
            ...
            sx={{ color: "#7a9b76", fontWeight: 600 }}
          >
            Đóng
          </Button>
        </DialogActions>
