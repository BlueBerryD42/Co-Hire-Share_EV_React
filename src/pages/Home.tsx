...
const Home = () => {
  return (
    <div className="w-full">
      {/* Overview Section */}
      <section id="overview" className="mx-auto flex max-w-6xl flex-col gap-10 px-6 py-12 scroll-mt-20">
        <div className="space-y-6">
          ...
          <p className="max-w-2xl text-lg text-neutral-600">
            Co-Hire Share EV is a comprehensive platform designed to revolutionize electric vehicle co-ownership.
            Our solution connects multiple stakeholders, enabling seamless sharing of electric vehicles through
            intelligent scheduling, transparent cost management, and community-driven collaboration.
          </p>

          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-xl border border-neutral-200 bg-neutral-100 p-6">
              <h3 className="mb-2 text-lg font-semibold text-neutral-900">What We Do</h3>
              <p className="text-sm text-neutral-600">
                We facilitate electric vehicle co-ownership by providing tools for scheduling, billing,
                maintenance tracking, and group management.
              </p>
            </div>
            <div className="rounded-xl border border-neutral-200 bg-neutral-100 p-6">
              <h3 className="mb-2 text-lg font-semibold text-neutral-900">Who We Serve</h3>
              <p className="text-sm text-neutral-600">
                Families, communities, businesses, and organizations looking to share electric vehicles
            ...
            <div className="rounded-xl border border-neutral-200 bg-neutral-100 p-6">
              ...
              <p className="text-sm text-neutral-600">
                Making sustainable transportation accessible and affordable through innovative
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-10 text-center">
            ...
            <p className="mx-auto max-w-2xl text-lg text-neutral-600">
              Discover the advantages of sharing electric vehicles through our platform
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <article className="rounded-2xl border border-neutral-200 bg-neutral-50 p-8 shadow-sm">
              ...
              <p className="text-neutral-600 leading-relaxed">
                Save up to 60% compared to traditional vehicle ownership by sharing purchase, insurance,
                maintenance, and charging expenses with your group members.
              </p>
            </article>
            ...
            <article className="rounded-2xl border border-neutral-200 bg-neutral-50 p-8 shadow-sm">
              ...
              <p className="text-neutral-600 leading-relaxed">
                Reduce your carbon footprint by maximizing vehicle utilization and promoting sustainable
                transportation practices within your community.
              </p>
            </article>
            ...
            <article className="rounded-2xl border border-neutral-200 bg-neutral-50 p-8 shadow-sm">
              ...
              <p className="text-neutral-600 leading-relaxed">
                Enjoy convenient vehicle access when you need it without the burden of full ownership,
                perfect for occasional or variable transportation needs.
              </p>
            </article>
            ...
            <article className="rounded-2xl border border-neutral-200 bg-neutral-50 p-8 shadow-sm">
              ...
              <p className="text-neutral-600 leading-relaxed">
                Connect with like-minded individuals who share your values around sustainability and
            ...
            <article className="rounded-2xl border border-neutral-200 bg-neutral-50 p-8 shadow-sm">
              ...
              <p className="text-neutral-600 leading-relaxed">
                Share the responsibility of vehicle maintenance and service scheduling, making ownership
                easier and less stressful for everyone.
              </p>
            </article>
            ...
            <article className="rounded-2xl border border-neutral-200 bg-neutral-50 p-8 shadow-sm">
              ...
              <p className="text-neutral-600 leading-relaxed">
                Monitor all expenses in real-time with automated billing and reporting, ensuring fair
                cost distribution and complete financial transparency.
              </p>
            </article>
          </div>
        </div>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <article className="rounded-2xl border border-neutral-200 bg-neutral-50 p-8 shadow-sm transition-all hover:shadow-md">
              <div className="mb-4">
                ...
                <p className="mt-2 text-sm text-neutral-600">Perfect for small groups</p>
              </div>
              <div className="mb-6">
              ...
              <ul className="mb-8 space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-neutral-700">Up to 2 vehicles</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="mt-0.5 h-5 w-5 flex-shrink-0 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-sm text-neutral-700">5 group members</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="mt-0.5 h-5 w-5 flex-shrink-0 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-sm text-neutral-700">Basic scheduling</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="mt-0.5 h-5 w-5 flex-shrink-0 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
            ...
            <article className="rounded-2xl border-2 border-accent-blue bg-neutral-50 p-8 shadow-lg">
              <div className="mb-4">
                ...
                <h3 className="text-xl font-semibold text-neutral-900">Professional</h3>
                <p className="mt-2 text-sm text-neutral-600">For growing fleets</p>
              </div>
              <div className="mb-6">
              ...
              <ul className="mb-8 space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-neutral-700">Up to 10 vehicles</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="mt-0.5 h-5 w-5 flex-shrink-0 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-sm text-neutral-700">Unlimited members</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="mt-0.5 h-5 w-5 flex-shrink-0 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
            ...
            <article className="rounded-2xl border border-neutral-200 bg-neutral-50 p-8 shadow-sm transition-all hover:shadow-md">
              ...
              <ul className="mb-8 space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-neutral-700">Unlimited vehicles</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="mt-0.5 h-5 w-5 flex-shrink-0 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-neutral-700">Dedicated support</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="mt-0.5 h-5 w-5 flex-shrink-0 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-sm text-neutral-700">SLA guarantee</span>
                </li>
              </ul>
              <button className="w-full rounded-lg border border-neutral-300 px-4 py-2 text-sm font-semibold text-neutral-700 transition-colors hover:border-accent-blue hover:text-accent-blue">
                Contact Sales
          ...
          <div className="mx-auto max-w-4xl">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <div className="rounded-xl border border-neutral-200 bg-neutral-50 p-6 text-center transition-shadow hover:shadow-md">
                ...
                <h4 className="mb-2 text-lg font-semibold text-neutral-900">Live Chat</h4>
                <p className="text-sm text-neutral-600 mb-3">Get instant answers from our support team</p>
                <p className="text-xs text-neutral-500 font-medium">Available 24/7</p>
              </div>
              ...
              <div className="rounded-xl border border-neutral-200 bg-neutral-50 p-6 text-center transition-shadow hover:shadow-md">
                ...
                <h4 className="mb-2 text-lg font-semibold text-neutral-900">Phone Support</h4>
                <p className="text-sm text-neutral-600 mb-3">Talk to our experts directly</p>
                <p className="text-xs text-neutral-500 font-medium">Mon-Fri 9AM-6PM EST</p>
              </div>
              ...
              <div className="rounded-xl border border-neutral-200 bg-neutral-50 p-6 text-center transition-shadow hover:shadow-md">
                ...
                <h4 className="mb-2 text-lg font-semibold text-neutral-900">Help Center</h4>
                <p className="text-sm text-neutral-600 mb-3">Browse FAQs and documentation</p>
                <p className="text-xs text-neutral-500 font-medium">Self-service resources</p>
              </div>
            </div>

            {/* Office Information */}
            <div className="mt-8 rounded-xl border border-neutral-200 bg-neutral-50 p-8 text-center">
              <h4 className="mb-4 text-lg font-semibold text-neutral-900">Our Office</h4>
              <p className="text-neutral-600">
                123 Electric Avenue, Suite 400<br />
